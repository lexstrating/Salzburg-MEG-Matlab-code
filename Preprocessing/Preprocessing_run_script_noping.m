%% Preprocessing_run_script_noping

% coded identifiers of all subjects in alphabetical order
subjects = {'bidt','eigl','eipo','mrhs','urmr'};
...
cfg = [];
cfg.faulty_trials = {faulty_trials_bidt,faulty_trials_eigl,...
    faulty_trials_eipo,faulty_trials_mrhs,faulty_trials_urmr};
